                      ...
                      : Material(
                          ...
                          borderRadius: _isExpanded && widget.theme?.fullExpandedBorder != null
                              ? BorderRadius.vertical(
                                  top: Radius.zero,
                                  bottom:
                                      Radius.circular(widget.theme?.fullExpandedBorder?.borderRadius.bottomLeft.x ?? 0),
                                )
                              : null,
                          child: Column(
                            children: [
                    ...
                    child: !_isExpanded
                        ...
                        : Material(
                            ...
                            shape: _isExpanded && widget.theme?.fullExpandedBorder != null
                                ...
                                : widget.theme?.contentBorder,
                            borderRadius:
                                _isExpanded && widget.theme?.fullExpandedBorder != null && widget.footer == null
                                    ? BorderRadius.vertical(
                                        top: Radius.zero,
                                        bottom: Radius.circular(
                                            widget.theme?.fullExpandedBorder?.borderRadius.bottomLeft.x ?? 0),
                                      )
                                    : null,
                            child: Column(
                              children: [
